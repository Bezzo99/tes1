...
#wget -q -O /usr/bin/bbr "https://raw.githubusercontent.com/Bezzo99/tes1/main/dll/bbr.sh"
#chmod +x /usr/bin/bbr
#bbr >/dev/null 2>&1
...
wget -q -O /usr/bin/cek-ws "https://raw.githubusercontent.com/Bezzo99/tes1/main/xray/cek-ws.sh" && chmod +x /usr/bin/cek-ws
wget -q -O /usr/bin/cek-vless "https://raw.githubusercontent.com/Bezzo99/tes1/main/xray/cek-vless.sh" && chmod +x /usr/bin/cek-vless
wget -q -O /usr/bin/cek-tr "https://raw.githubusercontent.com/Bezzo99/tes1/main/xray/cek-tr.sh" && chmod +x /usr/bin/cek-tr
wget -q -O /usr/bin/cek-ssws "https://raw.githubusercontent.com/Bezzo99/tes1/main/xray/cek-ssws.sh" && chmod +x /usr/bin/cek-ssws
wget -q -O /usr/bin/renew-ws "https://raw.githubusercontent.com/Bezzo99/tes1/main/xray/renew-ws.sh" && chmod +x /usr/bin/renew-ws
